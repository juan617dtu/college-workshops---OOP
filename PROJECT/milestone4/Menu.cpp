...
namespace seneca {
    ...
    Menu::Menu(const char *title, const char *exit_opt, unsigned int indent_num, unsigned int indent_size) :
    m_indentation(indent_num), m_indentation_size(indent_size),
    m_title(title, indent_num, indent_size, -1),
    m_exit_opt(exit_opt, indent_num, indent_size, 0),
    m_sel_prompt("> ", indent_num, indent_size, -1)
    {
